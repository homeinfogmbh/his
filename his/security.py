...
class NoSuchUser(Exception):
    """Indicates non existant user"""
    pass


class NoSessionToken(Exception):
    """Indicates an invalid session token"""
    pass
...
def authenticate(func):
    ...
    def session(*args, user_name=None, session_token=None, **kwargs):
        ...
        if user_name is None:
            ...
            if session_token is None:
                if user_pass is None:
                    ...
                    return login(*args, user_name=user_name,
                                 user_pass=user_pass, **kwargs)
            else:
                return session(*args, user_name=user_name,
